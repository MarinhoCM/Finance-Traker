...
INSERT INTO "new_recurring_earnings" ("active", "created_at", "earningsId", "id", "range_days", "recurring", "updated_at") SELECT "active", "created_at", "earningsId", "id", "range_days", "recurring", "updated_at" FROM "recurring_earnings";
